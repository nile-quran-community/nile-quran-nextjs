      ...
      <section className="relative bg-[#043F2E] text-white overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 md:px-10 py-16 md:py-20 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4 max-w-3xl">
            ...
            >
              مرحلة الجامعة من أكثر المراحل حساسية في حياة الشاب؛ فهي بداية فصل جديد تتشكل فيه
              شخصيته، ويخط فيه مقدمات مستقبله وطموحاته.
            </p>
            <p
              className={`${tajawal.className} text-base md:text-[17px] leading-[1.9] text-white/90 font-normal`}
            >
              وفي خضم هذه المرحلة، قد يصبح الشاب عرضة بسهولة لتأثير أصدقاء السوء والبيئات الفاسدة؛
              حيث تُزيَّن المعصية، وتُهدم الثوابت، وتتجاوز الحدود.
            </p>
            <p
              className={`${tajawal.className} text-base md:text-[17px] leading-[1.9] text-white/80 font-normal`}
            >
              ومن هنا ظهرت الحاجة إلى مجتمع يحتضن الشباب، ويثبتهم، ويذكرهم، ويؤكد لهم أن الخير موجود
              لمن أراده وسعى إليه.
            </p>
          </div>
        </div>
