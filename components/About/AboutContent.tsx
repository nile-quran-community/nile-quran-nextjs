        ...
        <div className="relative max-w-4xl mx-auto px-6 md:px-10 py-16 md:py-20 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4 max-w-3xl">
            ...
            >
              ...
              طريقه إليه؛ صحبةٍ يجد فيها من يعينه على أن يبقى القرآن حاضرًا في قلبه وحياته، وأن يعيش
              هذه المرحلة قريبًا من ربه، ثابتًا على قيمه، ومقبلًا على الخير.
            </p>
            <p
              className={`${tajawal.className} text-base md:text-[17px] leading-[1.9] text-white/80 font-normal`}
            >
              ومن هنا تبرز الحاجة إلى مجتمع يجمع الشباب على الخير، ويهيئ لهم بيئة صالحة ينمون فيها
